...
<body>
    ...
    <section class="form">
        <form action="" class="form-search">
            ...
            <div class="form-win ">
                <label for="">Right Digit</label>
                <br>
                <select name="Right Digit" id="Right Digit" class="form-control">
            ...
            <div class="form-win ">
                <label for="">Left Digit</label>
                <br>
                <select name="Left Digit" id="Left Digit" class="form-control">
                    <option value="">Select Option</option>
                    <option value=""></option>
                    <option value=""></option>
                </select>
                    ...
                    <table class="user-table-data" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width:10px;">Username</th>
                                <th style="min-width:15px;">Game Name</th>
                                <th style="min-width:10px;">Game Type</th>
                                <th style="min-width:10px;">Right Digit</th>
                                <th style="min-width:10px;">Left digit</th>
