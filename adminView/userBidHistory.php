                    ...
                    <table class="user-table-data" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width:10px;">Game Name</th>
                                <th style="min-width:9px;">Game Type</th>
                                <th style="min-width:9px;">Session</th>
                                <th style="min-width:9px;">Open Pana</th>
                                <th style="min-width:9px;">Open Result</th>
                                <th style="min-width:9px;">Close Pana</th>
                                <th style="min-width:9px;">Close Result</th>
                                <th style="min-width:9px;">Points</th>
                                <th style="min-width:9px;">Action</th>
                            </tr>
                        </thead>
                        <tbody>
							<?php
